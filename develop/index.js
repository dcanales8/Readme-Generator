...
function init() {
  inquirer
    .prompt([
      ...
      {
        type: "input",
        message: "Please enter name or Username",
        name: "name",
      },
      ...
      {
        type: "input",
        message: "Enter installation instructions of your project:",
        name: "installation",
      },
      ...
      {
        type: "list",
        message: "Please select the type of license you would like for your project:",
        choices: [
          "MIT",
          "Apache 2.0 License",
          "IBM Public License Version 1.0",
